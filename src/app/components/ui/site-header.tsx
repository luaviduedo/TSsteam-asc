...
export default function SiteHeader() {
  return (
    <header className="sticky top-0 z-50 border-b border-white/8 bg-[rgba(8,15,22,0.72)] backdrop-blur-2xl">
      <div className="mx-auto flex h-16 w-full max-w-[1560px] items-center justify-between gap-3 px-4 sm:px-6 lg:px-8 2xl:px-10">
        <Link
          href="/"
          className="group inline-flex min-w-0 items-center gap-3 text-white transition hover:opacity-100"
        >
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-sky-300/15 bg-[linear-gradient(180deg,#163246_0%,#101b25_100%)] shadow-[0_10px_24px_rgba(0,0,0,0.24),inset_0_1px_0_rgba(255,255,255,0.05)]">
          ...
          <div className="min-w-0 leading-tight">
            ...
            <p className="truncate text-sm font-semibold tracking-[-0.03em] text-white/92">
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          <Link
            ...
            className="inline-flex h-10 w-10 items-center justify-center rounded-lg border border-white/10 bg-white/[0.04] text-white/72 shadow-[0_10px_24px_rgba(0,0,0,0.20),inset_0_1px_0_rgba(255,255,255,0.04)] transition hover:border-sky-300/20 hover:bg-white/[0.07] hover:text-white"
          >
